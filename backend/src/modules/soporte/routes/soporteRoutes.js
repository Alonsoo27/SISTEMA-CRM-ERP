...
/**
 * @route   GET /api/soporte/tecnicos
 * @desc    Obtener lista de técnicos disponibles
 * @access  Private
 * @returns {Array} Lista de técnicos con id, nombre, apellido, email
 */
router.get('/tecnicos', manejarErrorAsync(SoporteController.obtenerTecnicos));

/**
 * @route   GET /api/soporte/dashboard/resumen
 * @desc    Obtener resumen completo para dashboard principal
 * @access  Private
 * CORREGIDO: Manejo correcto de respuestas usando el modelo directamente
 */
...
/**
 * Convertir datos de productos a formato CSV
 */
